...
const OrderInfoScreen = ({ navigation, route }) => {
  ...
  // Accept either a full order object (legacy) or just an orderId (from notification tap)
...
const styles = StyleSheet.create({
  ...
  infoCard: {
    ...
    marginHorizontal: 12, marginBottom: 16, borderRadius: 10, overflow: 'hidden',
  },
  ...
  sectionLabel: {
    ...
    color: '#ffffff', letterSpacing: 1, marginHorizontal: 16, marginBottom: 8,
  },
  itemCard: {
    flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.88)',
    marginHorizontal: 12, marginVertical: 6, borderRadius: 8, overflow: 'hidden',
  },
